...
namespace SteamWheel
{
    ...
    public sealed partial class Help : Page
    {
        ...
        private async void goIdConverter_Click(object sender, RoutedEventArgs e)
        {

            HttpClient client = new HttpClient();
            //var html = await client.GetStringAsync("http://steamidconverter.com/kbronctjr");

            var response = await client.GetAsync("http://steamidconverter.com/kbronctjr");
            ...
            msgPop.Pop(divContainer.InnerText, "Info");
        }
    }
}
